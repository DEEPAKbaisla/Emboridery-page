...
const Contact = () => {
  ...
  const validate = (form) => {
    ...
    if (!message) newErrors.massage = "Message is required.";
      ...
      newErrors.massage = "Message must be at least 15 characters.";
    return newErrors;
  };
    ...
    <div>
      <div className="contact">
        <div className="contact-title">
          ...
          <p>
            Reach out for special sale pricing on your custom embroidery needs.
          </p>

          <a
            className="contact-whatsapp desktop-only"
            href="https://wa.me/7988901458"
            target="_blank"
...
export default Contact
>>>>>>> ae6bf044c5390aabd04ba5193a50c66ab9f46b6d
